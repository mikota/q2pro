...
xhair_fast_transition::
    When switching weapons, the xhair will transition faster to the new gap/length.
...
cl_enhanced_footsteps::
    Specifies whether to play the original four step sounds (step1.wav ... 
    step4.wav) and landing sound (land1.wav). Or new improved twelve step
    sounds and eight landing sounds.
     - 0 - default behaviour with four step and one landing sounds
     - 1 - new behaviour with twelve step and eight landing sounds
